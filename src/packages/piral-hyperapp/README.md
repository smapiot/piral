...
By default, these extensions are not integrated in `piral`, so you'd need to add them to your Piral instance. The set includes an `register...Hyperapp` method for each `register...X` method of the standard API surface.
