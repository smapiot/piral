...
import { ApiExtender, buildName, GlobalStateContext } from 'piral-core';
import { withPiletState } from './withPiletState';
import { PiletContainersApi } from './types';

export function createContainerApi(context: GlobalStateContext): ApiExtender<PiletContainersApi> {
