...
To make rush aware of the app-shell package we need to add it to the `projects` setting inside the rush.json file like this (it should be automatically added, but make sure to check it and rename properly):
